...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-v2.0.33-blue?style=flat-square">
...
**v2.0.33** — Documentation, installation, AppImage, update, and release automation are synchronized from the root `VERSION` file.
